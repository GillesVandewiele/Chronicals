...
angular.module('Chronic').config(['$httpProvider', function ($httpProvider) {
    ...
    $scope.submitRegister = function () {
        ...
        success(function (data, status, headers, config) {
            ...
            navigator.notification.alert("Voor beveiligingsredenen is het nodig om enkele gegevens door te sturen naar de dokters van het uz, zodat ze later uw identiteit aan de data kunnen koppelen. Gelieve in het volgende scherm bij het mailtje op versturen te klikken.");
